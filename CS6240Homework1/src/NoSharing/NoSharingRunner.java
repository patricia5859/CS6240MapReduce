/*
 * 		NoSharingRunner: Implements Runnable Interface and includes following methods:
 *  		
...
class NoSharingRunner implements Runnable {
	...
	// Constructor
	public NoSharingRunner(List<String> list, HashMap<String, int[]> accumulationDS, Boolean fibonaciiFlag) {
